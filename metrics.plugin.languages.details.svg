<svg xmlns="http://www.w3.org/2000/svg" width="480" height="146" class="">
    <defs>
        <style/>
    </defs>
        ...
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" class="items-wrapper">
            ...
            <section class="column">
                ...
                <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="460" height="8">
                    ...
                    <rect mask="url(#languages-bar)" x="0" y="0" width="457.94511299599566" height="8" fill="#b07219"/>
                    <rect mask="url(#languages-bar)" x="457.94511299599566" y="0" width="0.7255506870227482" height="8" fill="#3178c6"/>
                    <rect mask="url(#languages-bar)" x="458.6706636830184" y="0" width="0.5830180767747213" height="8" fill="#00ADD8"/>
                    <rect mask="url(#languages-bar)" x="459.25368175979315" y="0" width="0.41110344541318505" height="8" fill="#555555"/>
                    <rect mask="url(#languages-bar)" x="459.66478520520633" y="0" width="0.3352147947937058" height="8" fill="#f1e05a"/>
                </svg>
